...
const WatchLater = () => {
  ...
  return (
    <div className='w-full h-full overflow-x-auto relative pt-4'>
    ...
    {
                watchLater.length < 1 &&     <Link to="/" className='px-4 py-2 h-9 self-center  absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] dark:bg-gray-300/60 bg-gray-500/40 rounded-2xl'>Please Add Some thing
                </Link>
