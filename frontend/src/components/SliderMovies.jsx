...
const Slide =({movie})=>{
    ...
    return(
        <div className='w-full h-full relative'>
            ...
            <div className='bg-[rgba(0,0,0,0.4)] px-4 py-7 backdrop-blur-[2px] w-[490px] h-auto absolute bottom-[15%] left-[7%] rounded-2xl'>
                ...
                <div>
                <h3 className='poppins text-left text-sm text-white mb-1'>Rating :<span className='text-xs'> {movie?.vote_average.toFixed(1)+"+"}</span></h3>
                </div>
